 ...
 * wrapper that each template composes; the templates only vary the
...
export interface EmailShellProps {
	...
	// the kicker → headline → body prose hierarchy (one shared wrapper).
	eyebrow?: string;
	children: ReactNode;
}
...
export function EmailShell({ preheader, eyebrow, children }: EmailShellProps) {
	return (
		<Html lang="en">
			 ...
			 * for first-party chrome, which this product does not do, and which would
			 * tell that host who opened our mail and when. The brand survives the loss:
